    ...
    return (
        <div className="flex min-h-screen items-center justify-start bg-white">
            <div className="mx-auto w-full max-w-lg">
                <h1 className="text-4xl font-medium text-center font-bold mb-3 text-blue-600">Contact us</h1>
                <p className="mt-3 text-center font-bold mb-3 text-blue-600">Email us at alfat.cse.21@gmail.com or message us here:</p>
                <form action="https://api.web3forms.com/submit" className="mt-10">
                    ...
                    {/* <button type="submit " className="mt-5 align-center rounded-md bg-black px-10 py-2 text-white">Send Message</button> */}
